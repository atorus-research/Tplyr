...
+ Setup: _No prerequisites required_
  ...
  + T9: counts can be produced using a pair of nested variables
    + T9.1: two variables with a nested relationship can be used to create counts
    + T9.2: A text string and a variable can be used to create counts
