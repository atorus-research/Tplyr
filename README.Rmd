...
We're working on posting to CRAN! We'll update as soon as it's accepted. In the mean time, you can install via:
...
- The best place to start is with our Getting Started vignette at `vignettes("Tplyr")`
