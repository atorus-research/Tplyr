...
- desc_layer_formats - default formats to be used on desc layers in the table
...
tplyr_table(adlb, TRTP, where = AVISIT == "Week 2" & PARAMCD == "URATE") %>%
  add_layer(
