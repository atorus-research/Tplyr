...
```{r table_params2}
tplyr_table(adsl, TRT01P, where= SAFFL =="Y", cols = quos(SEX, RACE)) %>% 
  add_layer(
    group_desc(AGE, by = "Age (Years)")
  ) %>% 
  build() %>% 
