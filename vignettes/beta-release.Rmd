...
You may have noticed the addition of `ord` columns on the datasets output so far. Tplyr now provides order columns built in to the table returned to you via the `build` function. This follows a few basic principles:
...
Our current implementation of risk difference is solely built on top of the base R function `prop.test`. For a any and all questions about this method, please review the `prop.test` documentation within R. 
