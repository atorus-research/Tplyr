...
In addition to missing counts, some summaries require the addition of a 'Total' row as well. 'Tplyr' has the helper function `add_total_row()` to ease this process for you. Like everything else that goes into 'Tplyr', this too has a significant bit of nuance to it. 
