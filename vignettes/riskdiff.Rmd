...
- Switched the alternative hypothesis of `prop.test` to "less" instead of the default "two.sided"
- Turned off the Yates' continuity correction

For more information on these parameters, see the documentation for `prop.test`. 
