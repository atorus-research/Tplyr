...
The idea behind this is really to support [Shiny](https://shiny.rstudio.com/). Consider this minimal application:


```{r, out.width=1100, out.extra='style="border: 1px solid #464646;" allowfullscreen="" allow="autoplay"', echo=FALSE}
knitr::include_app("https://michael-stackhouse.shinyapps.io/Tplyr-shiny-demo/")
```
